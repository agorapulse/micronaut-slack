...
@MicronautTest
@Property(name = 'micronaut.caches.slack-events.expire-after-write', value = '1h')
class CacheDuplicateEventsFilterSpec extends Specification {
    ...
    void 'basic guard'() {
        expect:
            eventsFilter instanceof CacheDuplicateEventsFilter
        and:
